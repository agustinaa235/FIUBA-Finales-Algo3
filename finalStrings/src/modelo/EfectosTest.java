...
public class EfectosTest {
    ...
    @Test
    public void testEfectoAgregarUn3AlFinalDeLaCadenaYPrimeraLetraAMinuscula(){
        String cadena = FabricaDeEfectos.CrearEfectoAgregar3AlFinalDELaCdenaYPrimeraLetraEnMinuscula().aplicarA("ALGO");
        Assert.assertEquals("aLGO3", cadena);

    }
    @Test
    public void testEfectoDarVueltaLaCadenaPasarLaPrimerLetraAMinusculaYAgregarElNumero4AlFinalDeLaCadena(){
        String cadena = FabricaDeEfectos.CrearEfectoDarVueltaLaCadenaAgregarUn4AlFinalYPonerLaPrimerLetraEnMinuscula().aplicarA("ALGO");
